...
Public Const C_Param_FolderOut     As String = "carpeta destino"
Public Const C_Param_Empresa       As String = "empresa"
Public Const C_Param_Circuito      As String = "circuito contable"
Public Const C_Param_Retencion     As String = "retencion"
