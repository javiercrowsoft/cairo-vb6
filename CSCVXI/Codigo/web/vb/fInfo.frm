...
Private Sub wb_BeforeNavigate2(ByVal pDisp As Object, URL As Variant, Flags As Variant, TargetFrameName As Variant, PostData As Variant, Headers As Variant, Cancel As Boolean)
  ...
  Exit Sub
ControlError:
  MngError Err, "wb_BeforeNavigate2", C_Module, ""
End Sub
...
Public Sub SetPositionForm()
  ...
  Me.Left = fMain.Left + fMain.lvInfo.Left + offset
  Me.Width = fMain.lvInfo.Width
  Me.Top = fMain.Top _
           + fMain.lvInfo.Top _
           + fMain.lvInfo.Height _
           + (fMain.Height - fMain.ScaleHeight) - offsetTop
  Me.Height = fMain.lvLog.Top _
                - (fMain.lvInfo.Top + fMain.lvInfo.Height) ' _
                    + (fMain.Height - (fMain.ScaleHeight - fMain.sbMain.Height)))
End Sub
