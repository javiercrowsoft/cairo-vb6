/*---------------------------------------------------------------------
Nombre: Ranking de Ventas por Cliente (sin empresa)
---------------------------------------------------------------------*/
/*  

Para testear:

DC_CSC_VEN_0279 1, '20060501','20060509','0', '0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0279]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0279]

go
create procedure DC_CSC_VEN_0279 (
...
create table #t_DC_CSC_VEN_0279(
                                cli_id        int,
...
create table #t_DC_CSC_VEN_0279_t (
...
insert into #t_DC_CSC_VEN_0279_t 
...
/////////////////////////////////////////////////////////////////////// */
  ...
  from #t_DC_CSC_VEN_0279 t1, #t_DC_CSC_VEN_0279_t t2
