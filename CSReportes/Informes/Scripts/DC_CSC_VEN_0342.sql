...
DC_CSC_VEN_0342 1, '20060501','20060530','0', '0','0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0342]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0342]

go
create procedure DC_CSC_VEN_0342 (
...
create table #t_DC_CSC_VEN_0342_rv (rv_id int)

	insert into #t_DC_CSC_VEN_0342_rv (rv_id)
	select rv_id
	from RemitoVenta rv
...
create table #t_DC_CSC_VEN_0342_ncnd (fv_id int)

	insert into #t_DC_CSC_VEN_0342_ncnd (fv_id)
	select fv_id
...
create table #t_DC_CSC_VEN_0342_fv (fv_id int)

	insert into #t_DC_CSC_VEN_0342_fv (fv_id)
	select fv_id
	from FacturaVenta fv
	where fv_fecha between @@Fini and @@Ffin
		and (fv.cli_id  = @cli_id or @cli_id=0)
...
create table #t_DC_CSC_VEN_0342(
												        pr_id				  int,
...
insert into #t_DC_CSC_VEN_0342
		...
		/////////////////////////////////////////////////////////////////////// */
		        ...
		        pr.pr_id,
		      	pr_codigo 							as Codigo,
		    		pr_nombreVenta  				as Articulo,
						isnull(rv.ven_id,cli.ven_id) as ven_id,
		    		sum (
		    			  	case 
		    ...
		    from 
		      ...
		      (RemitoVenta rv inner join #t_DC_CSC_VEN_0342_rv t on rv.rv_id = t.rv_id)
		...
		/////////////////////////////////////////////////////////////////////// */
		    select
		        pr.pr_id,
		      	pr_codigo 							as Codigo,
		    		pr_nombreVenta  				as Articulo,
						isnull(fv.ven_id,cli.ven_id) as ven_id,
		    		sum (
		    			  	case 
		    ...
		    from 
		      ...
		      (facturaventa fv	inner join #t_DC_CSC_VEN_0342_ncnd t on fv.fv_id = t.fv_id)
		...
		/////////////////////////////////////////////////////////////////////// */
		    ...
		    from 
		      ...
		      (facturaventa fv	inner join #t_DC_CSC_VEN_0342_fv t on fv.fv_id = t.fv_id)
...
create table #t_DC_CSC_VEN_0342_t (
															rvi_neto 			decimal(18,6),
															rvi_iva  			decimal(18,6),
															rvi_importe 	decimal(18,6)
														)

insert into #t_DC_CSC_VEN_0342_t 
...
/////////////////////////////////////////////////////////////////////// */
	...
	from #t_DC_CSC_VEN_0342 t1

				left join Vendedor ven on t1.ven_id = ven.ven_id
				left join #t_DC_CSC_VEN_0342_t t2 on 1=1
	...
	order by ven_nombre	+ '['+ven_codigo+']', Cantidad desc
