/*---------------------------------------------------------------------
Nombre: Ventas por Vendedor, Rubro, Empresa, Cliente, Articulo
---------------------------------------------------------------------*/
/*  

Para testear:
sp_col rubro
DC_CSC_VEN_0313 1, '20051101','20051110','0', '0','0','0','0','0','0','0','0'

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0313]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0313]

go
create procedure DC_CSC_VEN_0313 (
...
order by Vendedor, Rubro, Empresa, Cliente, Articulo
