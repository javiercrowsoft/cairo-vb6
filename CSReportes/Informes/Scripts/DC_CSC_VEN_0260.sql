/*---------------------------------------------------------------------
Nombre: Lista de Ventas por Cliente Padre, Cliente y Cuenta Contable
---------------------------------------------------------------------*/
...
DC_CSC_VEN_0260 
                    ...
                    '0'
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0260]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0260]

go
create procedure DC_CSC_VEN_0260 (
...
insert into #DC_CSC_VEN_0260 (cli_id,cue_id,emp_id,suc_id,total,pendiente)
...
having round(sum(cobz_pendiente),2)<>0 or @@soloDeudores = 0

--//////////////////////////////////////////
-- Facturas y Notas de Credito
--//////////////////////////////////////////

insert into #DC_CSC_VEN_0260 (cli_id,cue_id,emp_id,suc_id,neto,descuento,subtotal,iva,total,pendiente)
...
having round(sum(fv_pendiente),2)<>0 or @@soloDeudores = 0
...
--/////////////////////////////////////////////////////////////////////////
  ...
  if @@bSoloSaldos <> 0 begin
    ...
    select     
            ...
            cli2.cli_nombre    as [Cliente Padre],
    ...
    from 
      ...
      #DC_CSC_VEN_0260 fv 
                      ...
                      left  join Cliente cli2                           on cli.cli_id_padre = cli2.cli_id
    group by 
