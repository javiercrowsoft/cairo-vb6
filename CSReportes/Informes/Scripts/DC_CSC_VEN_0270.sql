/*
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
Ventas por Vendedor Resumido agrupado por Vendedor (Remitos)
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
*/

if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0270]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0270]
GO

create procedure DC_CSC_VEN_0270 (
