...
exec [DC_CSC_VEN_9810] 1,'69','0',0,0,1,0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_9810]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_9810]

go
create procedure DC_CSC_VEN_9810 (
