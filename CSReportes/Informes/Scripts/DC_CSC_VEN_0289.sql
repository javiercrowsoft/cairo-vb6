...
DC_CSC_VEN_0289 1, '20060501','20060531','0', '0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0289]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0289]

go
create procedure DC_CSC_VEN_0289 (
...
create table #t_DC_CSC_VEN_0289(
												        cli_id				int,
...
create table #t_DC_CSC_VEN_0289_t (
...
insert into #t_DC_CSC_VEN_0289_t 
...
/////////////////////////////////////////////////////////////////////// */
	...
	from #t_DC_CSC_VEN_0289 t1, #t_DC_CSC_VEN_0289_t t2
