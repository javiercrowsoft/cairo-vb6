...
DC_CSC_TSR_0240 1,'20000101','20051231','0','0','0','0','0','0'

select * from rama where ram_nombre like 'el nombre de alguna rama de algun arbol de la tabla a listar'

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_TSR_0240]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_TSR_0240]

go
create procedure DC_CSC_TSR_0240 (
...
CHEQUES QUE CUMPLE CON LOS FILTROS

//////////////////////////////////////////////////////////////////////// */

		create table #t_cheques (cheq_id int)
		
		insert into #t_cheques (cheq.cheq_id)
		...
		where 
						  ...
						  @@Fini <= isnull(opg_fecha,mf_fecha)
					and	@@Ffin >= isnull(opg_fecha,mf_fecha)
		
					and (cheq.opg_id is not null or cheq.mf_id is not null)
		...
		and   (cheq.bco_id 	= @bco_id 	or @bco_id=0)
...
/////////////////////////////////////////////////////////////////////// */
		...
		select 
		            ...
		            case cheq_rechazado
								...
								cheq_importe      as [Importe Original],
		
		            cheq_descrip      as [Observaciones]
		
		from 
		
					Cheque cheq inner join #t_cheques t         on cheq.cheq_id   = t.cheq_id
...
TOTALES POR CUENTA DE BANCOS Y POR CHEQUES DE TERCERO
...
union all
		...
		select 
								...
								2		 as orden_id,
								null as cheq_id,
								null as cheq_rechazado_id, -- Es para que la grilla oculte la columna
								null as cheq_propio_id,		-- Es para que la grilla oculte la columna
								null as comp_id,
		            ...
		            null as [Empresa], 
								...
								null as [Doc. Comprobante],
								null as [Doc. Numero],
								null as [Doc. Cobranza],
								null as [Cobranza],
		            null as [Cobranza Numero],
		
								null as [Doc. Fondos],
								null as [Mov. Fondos],
		            null as [Mov. Fondos Numero],
		
								null as [Codigo],
								null as [Cliente],
		            isnull(bco_nombre,'') 
																	as [Banco],
								isnull(cue_nombre,'* Cheque de Terceros')
																	as [Cuenta],
		            null as [Moneda],
								null as [Numero],
					      ...
					      null as [Comprobante],
								...
								null as [Clearing],
								null as [Fecha Cobro],
								null as [Fecha Acreditacion],
								null as [Fecha Vto.],
		
		            null as [Rechazado],
		            null as [Fecha Rechazo],
		            ...
		            null as [Legajo],
								null as [Doc. OP],
								null as [Orden Pago],
		            null as [Orden Pago Numero],
		            null as [Proveedor],
		
		            sum(cheq_importe) as [Importe],

								null as [Importe Original],
		...
		order by orden_id, cuenta, proveedor
