-- TODO:EMPRESA
/*---------------------------------------------------------------------
Nombre: Nombre: Imputacion contable por documentos resumido
---------------------------------------------------------------------*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_CON_0071]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_CON_0071]
...
go
create procedure DC_CSC_CON_0071(
