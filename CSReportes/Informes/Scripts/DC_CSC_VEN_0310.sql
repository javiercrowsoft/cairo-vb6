...
Para testear:
sp_col rubro
DC_CSC_VEN_0310 1, '20051101','20051110','0', '0','0','0','0','0','0','0','0'

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0310]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0310]

go
create procedure DC_CSC_VEN_0310 (
...
order by Vendedor, Empresa, Cliente, Rubro, Articulo
