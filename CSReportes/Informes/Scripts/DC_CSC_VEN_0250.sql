/*---------------------------------------------------------------------
Nombre: Listado de ventas por provincia para liquidacion de Ingresos Brutos
---------------------------------------------------------------------*/
/*  

Para testear:

DC_CSC_VEN_0250 1, '20030101','20100201','0', '0','0','0','0','0','0'


*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0250]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0250]
