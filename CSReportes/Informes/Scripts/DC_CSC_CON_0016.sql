...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_CON_0016]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_CON_0016]

/*

select * from circuitocontable

[DC_CSC_CON_0016] 70,'20051001 00:00:00','20051031 00:00:00','1','5'


*/
go
create procedure DC_CSC_CON_0016 (
...
*/
    ...
    create table #t_DC_CSC_CON_0016 (col_dummy tinyint)
    ...
    begin
      ...
      insert into #t_DC_CSC_CON_0016 (col_dummy) values(1)
