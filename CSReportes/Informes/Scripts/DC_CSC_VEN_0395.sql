/*---------------------------------------------------------------------
Nombre: Ventas por Carpeta, Rubro, Articulo, Cliente, Empresa en Moneda Default, Costo y Origen
---------------------------------------------------------------------*/
/*  
...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0395]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0395]

go
create procedure DC_CSC_VEN_0395 (
...
create table #DC_CSC_VEN_0395_producto (
                                        nodo_id int,
                                        nodo_2 int,
                                        nodo_3 int,
                                        nodo_4 int,
...
while exists(select * from rama r
             where  arb_id = @@arb_id
                and not exists (select * from #DC_CSC_VEN_0395_producto where nodo_2 = r.ram_id)
                and not exists (select * from #DC_CSC_VEN_0395_producto where nodo_3 = r.ram_id)
                and not exists (select * from #DC_CSC_VEN_0395_producto where nodo_4 = r.ram_id)
                and not exists (select * from #DC_CSC_VEN_0395_producto where nodo_5 = r.ram_id)
                and not exists (select * from #DC_CSC_VEN_0395_producto where nodo_6 = r.ram_id)
                and not exists (select * from #DC_CSC_VEN_0395_producto where nodo_7 = r.ram_id)
                and not exists (select * from #DC_CSC_VEN_0395_producto where nodo_8 = r.ram_id)
                and not exists (select * from #DC_CSC_VEN_0395_producto where nodo_9 = r.ram_id)
...
begin
  ...
  if @n = 2 begin
    ...
    insert #DC_CSC_VEN_0395_producto (nodo_id, nodo_2) 
    select ram_id, ram_id from rama where ram_id_padre = @raiz

  end else begin if @n = 3 begin

    insert #DC_CSC_VEN_0395_producto (nodo_id, nodo_2, nodo_3) 
    select ram_id, nodo_2, ram_id 
    from rama r inner join #DC_CSC_VEN_0395_producto n on r.ram_id_padre = n.nodo_2

  end else begin if @n = 4 begin

    insert #DC_CSC_VEN_0395_producto (nodo_id, nodo_2, nodo_3, nodo_4) 
    select ram_id, nodo_2, nodo_3, ram_id
    from rama r inner join #DC_CSC_VEN_0395_producto n on r.ram_id_padre = n.nodo_3

  end else begin if @n = 5 begin

    insert #DC_CSC_VEN_0395_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5) 
    select ram_id, nodo_2, nodo_3, nodo_4, ram_id
    from rama r inner join #DC_CSC_VEN_0395_producto n on r.ram_id_padre = n.nodo_4

  end else begin if @n = 6 begin

    insert #DC_CSC_VEN_0395_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6) 
    select ram_id, nodo_2, nodo_3, nodo_4, nodo_5, ram_id
    from rama r inner join #DC_CSC_VEN_0395_producto n on r.ram_id_padre = n.nodo_5

  end else begin if @n = 7 begin

    insert #DC_CSC_VEN_0395_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7) 
    select ram_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, ram_id
    from rama r inner join #DC_CSC_VEN_0395_producto n on r.ram_id_padre = n.nodo_6

  end else begin if @n = 8 begin

    insert #DC_CSC_VEN_0395_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7, nodo_8) 
    select ram_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7, ram_id
    from rama r inner join #DC_CSC_VEN_0395_producto n on r.ram_id_padre = n.nodo_7

  end else begin if @n = 9 begin

    insert #DC_CSC_VEN_0395_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7, nodo_8, nodo_9) 
    select ram_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7, nodo_8, ram_id
    from rama r inner join #DC_CSC_VEN_0395_producto n on r.ram_id_padre = n.nodo_8
...
create table #t_DC_CSC_VEN_0395_fv(fv_id int)

  insert into #t_DC_CSC_VEN_0395_fv
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
--
-- Cargamos la tabla #t_DC_CSC_VEN_0395 con todas las ventas
--
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

create table #t_DC_CSC_VEN_0395(fv_id           int not null,
                                pr_id           int not null, 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
          ...
          --//
              insert into #t_DC_CSC_VEN_0395 (fv_id, pr_id, mon_id, stl_id, fv_descuento1, fv_descuento2, 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  update #t_DC_CSC_VEN_0395 set venta        = venta * abs(cantidad), 
                                venta_origen = venta_origen * abs(cantidad) 

  update #t_DC_CSC_VEN_0395 set venta = (venta
...
------------------------------------------------------------------------------------------------------------------------
            ...
            insert into #t_DC_CSC_VEN_0395 (fv_id, pr_id, mon_id, stl_id,
                                            pr_esKit, pr_ventacompra, cantidad, venta)
...
insert into #t_DC_CSC_VEN_0395 (fv_id, pr_id, mon_id, pr_esKit, pr_ventacompra, cantidad, venta)
        ...
        group by
            ...
            --//
                    ...
                    where #t_DC_CSC_VEN_0395.fv_id = fv.fv_id
...
----------------------------------------------------------------------------------------
  ...
  -- Para resolver Kits
  --
  create table #t_DC_CSC_VEN_0395_i (pr_id         int not null, 
                                     mon_id       int not null,
...
declare c_precios insensitive cursor for select pr_id, pr_esKit, pr_ventacompra, stl_id from #t_DC_CSC_VEN_0395
    ...
    if @@metodoVal = 2 begin
      ...
      if @pr_esKit <> 0 begin
        ...
        --
          ...
          from #t_DC_CSC_VEN_0395_i where pr_id = @pr_id_item
          ...
          if @costo_item is null begin
            ...
            insert into #t_DC_CSC_VEN_0395_i (pr_id, mon_id, costo, costo_origen) 
          ...
          if @@bShowInsumo <> 0 begin
            insert into  #t_DC_CSC_VEN_0395 (pr_id, mon_id_costo, pr_esKit, pr_ventacompra, pr_id_insumo , cantidad, costo, costo_origen)
...
if @@mon_id_informe <> @mon_id_legal begin
  ...
  declare c_fv_moneda insensitive cursor for 
        ...
        from #t_DC_CSC_VEN_0395 fvi inner join FacturaVenta fv on fvi.fv_id = fv.fv_id
  ...
  begin
    ...
    if @fv_last_fecha <> @fv_fecha or @fv_last_fecha is null begin
      ...
      where #t_DC_CSC_VEN_0395.fv_id  = fv.fv_id 
        and #t_DC_CSC_VEN_0395.mon_id <> @@mon_id_informe 
      ...
      where #t_DC_CSC_VEN_0395.fv_id        = fv.fv_id 
        and #t_DC_CSC_VEN_0395.mon_id_costo <> @@mon_id_informe 
        and fv.fv_fecha                     = @fv_fecha
...
--         end
        venta_origen            as [Neto Origen],

        monc.mon_nombre         as [Moneda Costo],
        costo_origen            as [Costo Unit. origen],
        cantidad * costo_origen as [Costo Origen],
...
--         end
        venta_mon_informe             as [Neto Mon. Informe],

        costo_mon_informe             as [Costo Unit. Mon. Informe],
        cantidad * costo_mon_informe   as [Costo Mon. Informe]

    from 

      #t_DC_CSC_VEN_0395 fvi
          ...
          left  join #DC_CSC_VEN_0395_producto nodo on h.ram_id = nodo.nodo_id
