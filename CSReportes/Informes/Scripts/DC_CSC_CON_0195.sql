/*---------------------------------------------------------------------
Nombre: Detalle de Imputacion Contable de Compras
---------------------------------------------------------------------*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_CON_0195]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_CON_0195]
...
create procedure DC_CSC_CON_0195 (
...
--//////////////////////////////////////////////////////////////////////////////////////////
    ...
    from asiento ast inner join asientoitem asi  on ast.as_id  = asi.as_id
                     ...
                     inner join facturaCompra fc on ast.id_cliente = fc.fc_id

    where doct_id_cliente in (2,8,10) 
  ...
  order by as_fecha, fc_id, asi_orden
