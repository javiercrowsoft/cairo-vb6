...
DC_CSC_TSR_0036 1,'20000101','20051231','0','0','0','0','0'

select * from rama where ram_nombre like 'el nombre de alguna rama de algun arbol de la tabla a listar'

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_TSR_0036]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_TSR_0036]

go
create procedure DC_CSC_TSR_0036 (
...
where 
			...
			and cheq_fechacobro >= @@FechaCobro
