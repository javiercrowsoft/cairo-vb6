/*---------------------------------------------------------------------
Nombre: Ventas por Vendedor, Empresa, Rubro, Articulo, Cliente
---------------------------------------------------------------------*/
/*  

Para testear:
sp_col rubro
DC_CSC_VEN_0311 1, '20051101','20051110','0', '0','0','0','0','0','0','0','0'

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0311]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0311]

go
create procedure DC_CSC_VEN_0311 (
...
order by Vendedor, Empresa, Rubro, Articulo, Cliente
