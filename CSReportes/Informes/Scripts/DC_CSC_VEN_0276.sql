...
DC_CSC_VEN_0276 1, '20060101','20060430','0', '0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0276]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0276]

go
create procedure DC_CSC_VEN_0276 (
...
create table #t_dc_csc_ven_0276(
												        ven_id				int,
...
create table #t_dc_csc_ven_0276_t (
															emp_id 		int,
															rv_neto 	decimal(18,6),
															rv_iva  	decimal(18,6),
															rv_total 	decimal(18,6)
...
insert into #t_dc_csc_ven_0276_t 
...
/////////////////////////////////////////////////////////////////////// */
	...
	from #t_dc_csc_ven_0276 t1 inner join #t_dc_csc_ven_0276_t t2 on t1.emp_id = t2.emp_id
