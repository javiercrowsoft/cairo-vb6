...
---------------------------------------------------------------------*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_CON_0080]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_CON_0080]
...
go
create procedure DC_CSC_CON_0080(
...
select 
    ...
    fc_fecha                as Fecha,
    prov_razonsocial        as [Cliente/Proveedor],
...
select 
    ...
    opg_nrodoc              as Comprobante,
		...
		opgi_fechaRetencion     as [Fecha Ret.],
...
/////////////////////////////////////////////////////////////////////// */
and   (opgi.cue_id     = @cue_id      or @cue_id=0)
...
select 
    ...
    perc_nombre             as Impuesto,
    fv_fecha                as Fecha,
    cli_razonsocial         as [Cliente/Cliente],
...
select 
    ...
    ret_nombre                as Impuesto,
    cobz_fecha                as Fecha,
    cli_razonsocial           as [Cliente/Proveedor],
		cli_codigo							  as Codigo,
    cli_cuit                  as CUIT,
    'COB'                     as Tipo,
    cobz_nrodoc               as Comprobante,
		...
		cobzi_fechaRetencion      as [Fecha Ret.],
...
/////////////////////////////////////////////////////////////////////// */
and   (cobzi.cue_id    = @cue_id      or @cue_id=0)
