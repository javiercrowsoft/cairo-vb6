/*
---------------------------------------------------------------------
Nombre: Ranking de venta por Vendedor (resumido)
---------------------------------------------------------------------
*/
...
from vendedor v inner join FacturaVenta      fv     on v.ven_id    = fv.ven_id
...
DC_CSC_VEN_0060 1, '20051101','20051201','0', '0','0','0','0','0','0'

DC_CSC_VEN_0235 1, '20051101','20051201','0', '0','0','0','0','0','0'
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0060]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0060]

go
create procedure DC_CSC_VEN_0060 (
