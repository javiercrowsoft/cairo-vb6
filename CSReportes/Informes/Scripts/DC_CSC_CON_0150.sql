...
Nombre: Libro Diario
---------------------------------------------------------------------*/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[DC_CSC_CON_0150]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_CON_0150]
GO
...
create procedure DC_CSC_CON_0150 (
...
and   (ast.doc_id = @doc_id or ast.doc_id_cliente = @doc_id  or @doc_id  =0)
