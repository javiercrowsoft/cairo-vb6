/*---------------------------------------------------------------------
Nombre: Ventas por Cliente, Empresa, Vendedor, Rubro, Articulo
---------------------------------------------------------------------*/
/*  
...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0392]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0392]

go
create procedure DC_CSC_VEN_0392 (
...
create table #DC_CSC_VEN_0392_producto (
																				nodo_id int,
																				nodo_2 int,
																				nodo_3 int,
																				nodo_4 int,
...
while exists(select * from rama r
						 where  arb_id = @@arb_id
								and not exists (select * from #DC_CSC_VEN_0392_producto where nodo_2 = r.ram_id)
								and not exists (select * from #DC_CSC_VEN_0392_producto where nodo_3 = r.ram_id)
								and not exists (select * from #DC_CSC_VEN_0392_producto where nodo_4 = r.ram_id)
								and not exists (select * from #DC_CSC_VEN_0392_producto where nodo_5 = r.ram_id)
								and not exists (select * from #DC_CSC_VEN_0392_producto where nodo_6 = r.ram_id)
								and not exists (select * from #DC_CSC_VEN_0392_producto where nodo_7 = r.ram_id)
								and not exists (select * from #DC_CSC_VEN_0392_producto where nodo_8 = r.ram_id)
								and not exists (select * from #DC_CSC_VEN_0392_producto where nodo_9 = r.ram_id)
...
begin
	...
	if @n = 2 begin
		...
		insert #DC_CSC_VEN_0392_producto (nodo_id, nodo_2) 
		select ram_id, ram_id from rama where ram_id_padre = @raiz

	end else begin if @n = 3 begin

		insert #DC_CSC_VEN_0392_producto (nodo_id, nodo_2, nodo_3) 
		select ram_id, nodo_2, ram_id 
		from rama r inner join #DC_CSC_VEN_0392_producto n on r.ram_id_padre = n.nodo_2

	end else begin if @n = 4 begin

		insert #DC_CSC_VEN_0392_producto (nodo_id, nodo_2, nodo_3, nodo_4) 
		select ram_id, nodo_2, nodo_3, ram_id
		from rama r inner join #DC_CSC_VEN_0392_producto n on r.ram_id_padre = n.nodo_3

	end else begin if @n = 5 begin

		insert #DC_CSC_VEN_0392_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5) 
		select ram_id, nodo_2, nodo_3, nodo_4, ram_id
		from rama r inner join #DC_CSC_VEN_0392_producto n on r.ram_id_padre = n.nodo_4

	end else begin if @n = 6 begin

		insert #DC_CSC_VEN_0392_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6) 
		select ram_id, nodo_2, nodo_3, nodo_4, nodo_5, ram_id
		from rama r inner join #DC_CSC_VEN_0392_producto n on r.ram_id_padre = n.nodo_5

	end else begin if @n = 7 begin

		insert #DC_CSC_VEN_0392_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7) 
		select ram_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, ram_id
		from rama r inner join #DC_CSC_VEN_0392_producto n on r.ram_id_padre = n.nodo_6

	end else begin if @n = 8 begin

		insert #DC_CSC_VEN_0392_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7, nodo_8) 
		select ram_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7, ram_id
		from rama r inner join #DC_CSC_VEN_0392_producto n on r.ram_id_padre = n.nodo_7

	end else begin if @n = 9 begin

		insert #DC_CSC_VEN_0392_producto (nodo_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7, nodo_8, nodo_9) 
		select ram_id, nodo_2, nodo_3, nodo_4, nodo_5, nodo_6, nodo_7, nodo_8, ram_id
		from rama r inner join #DC_CSC_VEN_0392_producto n on r.ram_id_padre = n.nodo_8
...
create table #t_DC_CSC_VEN_0392_fv(fv_id int)

	insert into #t_DC_CSC_VEN_0392_fv
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
--
-- Cargamos la tabla #t_DC_CSC_VEN_0392 con todas las ventas
--
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

create table #t_DC_CSC_VEN_0392(fv_id           int not null,
																pr_id 		      int not null, 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					...
					--//
							insert into #t_DC_CSC_VEN_0392 (fv_id, pr_id, stl_id, fv_descuento1, fv_descuento2, 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	update #t_DC_CSC_VEN_0392 set venta = venta * abs(cantidad)
	update #t_DC_CSC_VEN_0392 set venta = (venta
...
------------------------------------------------------------------------------------------------------------------------
						...
						insert into #t_DC_CSC_VEN_0392 (fv_id, pr_id, stl_id,
																						pr_esKit, pr_ventacompra, cantidad, venta)
...
insert into #t_DC_CSC_VEN_0392 (fv_id, pr_id, pr_esKit, pr_ventacompra, cantidad, venta)
...
----------------------------------------------------------------------------------------
	...
	-- Para resolver Kits
	--
  create table #t_DC_CSC_VEN_0392_i (pr_id int not null, costo decimal(18,6) not null)
...
declare c_precios insensitive cursor for select pr_id, pr_esKit, pr_ventacompra, stl_id from #t_DC_CSC_VEN_0392
...
--
      ...
      if @pr_esKit <> 0 begin
        ...
        --
          ...
          select @costo_item = costo from #t_DC_CSC_VEN_0392_i where pr_id = @pr_id_item
          ...
          if @costo_item is null begin
            ...
            insert into #t_DC_CSC_VEN_0392_i (pr_id, costo) values (@pr_id_item, @costo_item)

          end

          if @@bShowInsumo <> 0 begin
            insert into  #t_DC_CSC_VEN_0392 (pr_id,  pr_esKit, pr_ventacompra, pr_id_insumo , cantidad, costo)
...
-- 				end
    ...
    from 
			...
			#t_DC_CSC_VEN_0392 fvi
					...
					left  join #dc_csc_ven_0392_producto nodo on h.ram_id = nodo.nodo_id
