/*---------------------------------------------------------------------
Nombre: Ranking de Ventas por Empresa, Cliente 
---------------------------------------------------------------------*/
/*  

Para testear:

DC_CSC_VEN_0278 1, '20060101','20060430','0', '0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0278]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0278]

go
create procedure DC_CSC_VEN_0278 (
...
create table #t_DC_CSC_VEN_0278(
                                cli_id        int,
        ...
        select
            ...
            sum (
                  case 
                    ...
                    when     rv.doct_id = 7
                        and rv_total <> 0
                               then  -rv_neto *(rv_pendiente/rv_total)                 
            ...
            sum (
                  case 
                    ...
                    when     rv.doct_id = 7 
                        and rv_total <> 0      
                                then  -(rv_ivari+rv_ivarni)*(rv_pendiente/rv_total)
...
create table #t_DC_CSC_VEN_0278_t (
                              emp_id     int,
                              rv_neto   decimal(18,6),
                              rv_iva    decimal(18,6),
                              rv_total   decimal(18,6)
...
insert into #t_DC_CSC_VEN_0278_t 
...
VENTAS POR CLIENTE AGRUPADAS POR EMPRESA
...
/////////////////////////////////////////////////////////////////////// */
  ...
  from #t_DC_CSC_VEN_0278 t1 inner join #t_DC_CSC_VEN_0278_t t2 on t1.emp_id = t2.emp_id
