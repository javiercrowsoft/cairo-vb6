/*---------------------------------------------------------------------
Nombre: Stock por Artículo Valorizado
...
---------------------------------------------------------------------*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_STK_0220]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_STK_0220]
...
--
      ...
      if @pr_esKit <> 0 begin
        ...
        --
          ...
          select @costo_item = costo from #t_DC_CSC_STK_0220_i where pr_id = @pr_id_item
          ...
          if @costo_item is null begin
            ...
            insert into #t_DC_CSC_STK_0220_i (pr_id, costo) values (@pr_id_item, @costo_item)

          end

          if @@bShowInsumo <> 0 begin
            insert into  #t_DC_CSC_STK_0220 (pr_id,  pr_esKit, pr_stockcompra, pr_id_insumo , cantidad, costo)
