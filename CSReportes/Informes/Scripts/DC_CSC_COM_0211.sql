/*---------------------------------------------------------------------
Nombre: Imputacion Contable de Documentos de Compra (El saldo inicial es por proveedor)
---------------------------------------------------------------------*/
/*  
...
exec DC_CSC_COM_0211 1,'20060501','20070430','0','0','0',0,'1',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_COM_0211]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_COM_0211]
