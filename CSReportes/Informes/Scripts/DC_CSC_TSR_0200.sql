...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_TSR_0200]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_TSR_0200]


-- exec [DC_CSC_TSR_0200] 3,'20080101 00:00:00','20090601 00:00:00',0,'N82547','0','0','N82550','N82557',0

go
create procedure DC_CSC_TSR_0200 (
...
/////////////////////////////////////////////////////////////////////// */
  ...
  exec DC_CSC_TSR_0200_aux5

                              @pr_id_cmp    ,
                              @pr_id_exc    ,
                              @@pr_id_inc    , -- excluyo gastos
                              ...
                              @ram_id_producto_cmp   ,
                              @ram_id_producto_exc  ,
                              @ram_id_producto_inc  , -- excluyo gastos
                              0                      ,
