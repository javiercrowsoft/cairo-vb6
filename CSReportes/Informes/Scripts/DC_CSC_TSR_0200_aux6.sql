...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_TSR_0200_aux6]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_TSR_0200_aux6]
...
go
create procedure DC_CSC_TSR_0200_aux6 (
...
set nocount on
    ...
    insert into #t_costos(pr_id, cue_id, importe, mes)
      ...
      select   fvi.pr_id, 
              null,
              sum(case fv.doct_id when 7 then -fvi_neto else fvi_neto end),
    ...
    /////////////////////////////////////////////////////////////////////// */
    exec DC_CSC_TSR_0200_aux3 @@Fini, @@Ffin, 1 /*ventas*/
