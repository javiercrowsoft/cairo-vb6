/*---------------------------------------------------------------------
Nombre: Ranking de Ventas por Empresa, Cliente (Remitos)
---------------------------------------------------------------------*/
/*  

Para testear:

DC_CSC_VEN_0288 1, '20060101','20060430','0', '0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0288]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0288]

go
create procedure DC_CSC_VEN_0288 (
...
create table #t_DC_CSC_VEN_0288(
												        cli_id				int,
...
create table #t_DC_CSC_VEN_0288_t (
															emp_id 		int,
															rv_neto 	decimal(18,6),
															rv_iva  	decimal(18,6),
															rv_total 	decimal(18,6)
...
insert into #t_DC_CSC_VEN_0288_t 
...
/////////////////////////////////////////////////////////////////////// */
	...
	from #t_DC_CSC_VEN_0288 t1 inner join #t_DC_CSC_VEN_0288_t t2 on t1.emp_id = t2.emp_id
