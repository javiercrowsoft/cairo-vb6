...
/*
	...
	[DC_CSC_COM_0280] 1,'20050101 00:00:00','20051231 00:00:00','0','0','0','1',-1,'2',3

*/

if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_COM_0280]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_COM_0280]

go
create procedure [dbo].[DC_CSC_COM_0280] (
...
create table #t_DC_CSC_COM_0280_3 ( prov_id 		int not null )

create table #t_DC_CSC_COM_0280_2 ( prov_id 		int not null,
																		debe        decimal(18,6) not null default(0),
																		haber       decimal(18,6) not null default(0)
																	)

create table #t_DC_CSC_COM_0280 (
...
--//////////////////////////////////////////
		...
		insert into #t_DC_CSC_COM_0280 (prov_id,cue_id,emp_id,suc_id,debe,haber)
...
--/////////////////////////////////////////////////////////////////////////
		...
		insert into #t_DC_CSC_COM_0280_2(prov_id, debe, haber)
		...
		group by fc.prov_id
			...
			-- 					 )
			-- 
			-- 		group by opg.prov_id

	insert into #t_DC_CSC_COM_0280_3

	select prov_id
	from #t_DC_CSC_COM_0280_2
	group by prov_id having sum(haber-debe)> @@minimo
...
--/////////////////////////////////////////////////////////////////////////
		...
		where exists(select * from #t_DC_CSC_COM_0280_3 where prov_id = fc.prov_id)
		...
		where 
				  ...
				  and exists(select * from #t_DC_CSC_COM_0280_3 where prov_id = fc.prov_id)
		...
		where 
				  ...
				  and exists(select * from #t_DC_CSC_COM_0280_3 where prov_id = opg.prov_id)
