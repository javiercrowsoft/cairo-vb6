...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_TSR_0220_aux5]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_TSR_0220_aux5]
...
go
create procedure DC_CSC_TSR_0220_aux5 (
...
*/
		...
		/////////////////////////////////////////////////////////////////////// */
		exec DC_CSC_TSR_0220_aux3 @@Fini, @@Ffin, 2 /*compras*/
