...
/*
 ...
 [DC_CSC_VEN_0050] 1,'20060501 00:00:00','20070430 00:00:00','0','0','1',0

*/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0050]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0050]
GO

create procedure DC_CSC_VEN_0050 (
...
-----------------------------------------------------
          ...
          select 
            ...
            ''                        as [Moneda],               
            -nc.fv_pendiente          as [Saldo],                
            -nc.fv_total              as [Total],      
            -(nc.fv_total
...
-----------------------------------------------------
          ...
          select 
            ...
            case 
              ...
              when fv_totalcomercial = 0 
               and fv_fechavto < getdate()
               and fv_fechavto < @@Ffin      then   fv_total
        
              else  0
          
            end                         as [Cobranza/NC Total],
