...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_TSR_0200_aux3]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_TSR_0200_aux3]
...
go
create procedure DC_CSC_TSR_0200_aux3 (
...
declare @importe   decimal(18,6)
    ...
    -- 
      ...
      --
      --      Para esto tengo el sp DC_CSC_TSR_0200_aux que recibe concepto_id, concepto, Fini y Ffin
    ...
    set @pr_id  = null
      ...
      begin
        ...
        exec DC_CSC_TSR_0200_aux @@Fini, @@Ffin, @pr_id, @cue_id, @@tipo
      ...
      begin
        ...
        exec DC_CSC_TSR_0200_aux2 @pr_id, 
                                  @cue_id,
                                  @@tipo,
                                  @mes,
                                  @importe
