...
DC_CSC_VEN_0235 1, '20051101','20051110','0', '0','0','0','0','0','0'

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0235]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0235]

go
create procedure DC_CSC_VEN_0235 (
...
order by vendedor, empresa, cliente
