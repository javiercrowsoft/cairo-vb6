...
DC_CSC_VEN_0333 1, '20060501','20060530','0', '0','0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0333]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0333]

go
create procedure DC_CSC_VEN_0333 (
...
create table #t_DC_CSC_VEN_0333(
												        pr_id				  int,
...
create table #t_DC_CSC_VEN_0333_t (
															rvi_neto 			decimal(18,6),
															rvi_iva  			decimal(18,6),
															rvi_importe 	decimal(18,6)
														)

insert into #t_DC_CSC_VEN_0333_t 
...
/////////////////////////////////////////////////////////////////////// */
	...
	from #t_DC_CSC_VEN_0333 t1, #t_DC_CSC_VEN_0333_t t2
