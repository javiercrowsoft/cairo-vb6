...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_TSR_0190_aux]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_TSR_0190_aux]
...
create table #t_meses(
  ...
  exec DC_CSC_TSR_0190_aux '20090223','20191211',1
...
go
create procedure DC_CSC_TSR_0190_aux (
