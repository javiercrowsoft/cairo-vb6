...
---------------------------------------------------------------------*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_CON_0095]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_CON_0095]


/*

 [DC_CSC_CON_0095] 1,'20060120 00:00:00','20060131 00:00:00','0','0','0',0,'0',0

 [DC_CSC_CON_0095] 1,'20060120 00:00:00','20060129 00:00:00','0','0','0',0,'0',0

*/

go
create procedure DC_CSC_CON_0095(
...
create table #t_dc_csc_con_0095 (
				[Orden]									int,
				as_id										int,
				id_cliente							int,
				doct_id_cliente					int,
...
/////////////////////////////////////////////////////////////////////// */
		...
		from #t_dc_csc_con_0095 asi	  inner join Cheque cheq          on asi.cheq_id  = cheq.cheq_id
