...
DC_CSC_VEN_0334 1, '20060501','20060530','0', '0','0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0334]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0334]

go
create procedure DC_CSC_VEN_0334 (
...
create table #t_DC_CSC_VEN_0334(
                                pr_id          int,
        ...
        select
            ...
            sum (
                  case 
                    ...
                    when     rv.doct_id = 24      
                        and  rvi_importe <> 0
                                then  - (rvi_pendientefac*(rvi_importe/rvi_cantidad))
                ...
                convert(varchar(7),rv_fecha,111)
...
create table #t_DC_CSC_VEN_0334_t (
                              rvi_neto       decimal(18,6),
                              rvi_iva        decimal(18,6),
                              rvi_importe   decimal(18,6)
                            )

insert into #t_DC_CSC_VEN_0334_t 
...
/////////////////////////////////////////////////////////////////////// */
  ...
  from #t_DC_CSC_VEN_0334 t1, #t_DC_CSC_VEN_0334_t t2
