/*---------------------------------------------------------------------
Nombre: Ranking de Ventas por Vendedor (Remitos)
---------------------------------------------------------------------*/
/*  

Para testear:

DC_CSC_VEN_0287 1, '20060101','20060430','0', '0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0287]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0287]

go
create procedure DC_CSC_VEN_0287 (
...
create table #t_DC_CSC_VEN_0287(
												        ven_id				int,
...
create table #t_DC_CSC_VEN_0287_t (
...
insert into #t_DC_CSC_VEN_0287_t 
...
/////////////////////////////////////////////////////////////////////// */
	...
	from #t_DC_CSC_VEN_0287 t1, #t_DC_CSC_VEN_0287_t t2
