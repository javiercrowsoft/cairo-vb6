/*
---------------------------------------------------------------------
Nombre: Pedidos de venta pendientes por Sucursal (cantidad pendiente)
---------------------------------------------------------------------
*/
...
from pedidoVenta pv inner join pedidoventaitem pvi on pv.pv_id   = pvi.pv_id
                    ...
                    inner join sucursal    suc     on  pv.suc_id = suc.suc_id
...
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0140]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0140]

go
create procedure DC_CSC_VEN_0140 (
