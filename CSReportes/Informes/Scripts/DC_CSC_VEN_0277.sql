/*---------------------------------------------------------------------
Nombre: Ranking de Ventas por Vendedor
---------------------------------------------------------------------*/
/*  

Para testear:

DC_CSC_VEN_0277 1, '20060101','20060430','0', '0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0277]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0277]

go
create procedure DC_CSC_VEN_0277 (
...
create table #t_DC_CSC_VEN_0277(
                                ven_id        int,
...
create table #t_DC_CSC_VEN_0277_t (
...
insert into #t_DC_CSC_VEN_0277_t 
...
/////////////////////////////////////////////////////////////////////// */
  ...
  from #t_DC_CSC_VEN_0277 t1, #t_DC_CSC_VEN_0277_t t2
