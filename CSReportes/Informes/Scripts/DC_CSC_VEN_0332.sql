...
DC_CSC_VEN_0332 1, '20060501','20060530','0', '0','0','0','0','0','0','0',0

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0332]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0332]

go
create procedure DC_CSC_VEN_0332 (
...
create table #t_DC_CSC_VEN_0332(
                                pr_id          int,
...
create table #t_DC_CSC_VEN_0332_t (
                              emp_id         int,
                              rvi_neto       decimal(18,6),
                              rvi_iva        decimal(18,6),
                              rvi_importe   decimal(18,6)
...
insert into #t_DC_CSC_VEN_0332_t 
...
/////////////////////////////////////////////////////////////////////// */
  ...
  from #t_DC_CSC_VEN_0332 t1 inner join #t_DC_CSC_VEN_0332_t t2 on t1.emp_id = t2.emp_id
