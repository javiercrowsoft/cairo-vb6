/*---------------------------------------------------------------------
Nombre: Ventas por Vendedor Resumido
---------------------------------------------------------------------*/
/*  

Para testear:

DC_CSC_VEN_0236 1, '20051101','20051110','0', '0','0','0','0','0','0'

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_VEN_0236]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_VEN_0236]

go
create procedure DC_CSC_VEN_0236 (
