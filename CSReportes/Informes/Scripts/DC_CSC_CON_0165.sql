...
---------------------------------------------------------------------*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_CON_0165]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_CON_0165]
...
/*
 ...
 [DC_CSC_CON_0165] 1,'20050201 00:00:00','20050531 00:00:00','423','0','0','4','0',0,'1',1

*/

go
create procedure DC_CSC_CON_0165(
