...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_TSR_0190]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_TSR_0190]


-- exec [DC_CSC_TSR_0190] 1,'20090101 00:00:00','20091231 00:00:00', 0,'0',0

go
create procedure DC_CSC_TSR_0190 (
...
-- 
	...
	--
	--			Para esto tengo el sp DC_CSC_TSR_0190_aux que recibe concepto_id, concepto, Fini y Ffin
...
set @pr_id  = null
	...
	begin
		...
		exec DC_CSC_TSR_0190_aux @@Fini, @@Ffin, @pr_id, @cue_id
	...
	begin
		...
		exec DC_CSC_TSR_0190_aux2 @pr_id, 
															@cue_id,
															@mes,
															@importe
