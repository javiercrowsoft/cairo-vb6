...
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_ENV_0050]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_ENV_0050]

go
create procedure DC_CSC_ENV_0050 (
  @@us_id    int,
  @@Fini      datetime,
  @@Ffin      datetime,
