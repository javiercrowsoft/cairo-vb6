/*---------------------------------------------------------------------
Nombre: Detalle de numeros de serie que figuran en la empresa
---------------------------------------------------------------------*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[DC_CSC_STK_0230]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[DC_CSC_STK_0230]

/*

 [DC_CSC_STK_0230] 1,'2814','668','0','0'

*/

go
create procedure DC_CSC_STK_0230 (
...
/////////////////////////////////////////////////////////////////////// */
	...
	(ProductoNumeroSerie ps inner join Producto p        
															on ps.pr_id = p.pr_id
														and (ps.prns_id = @prns_id 
																	or @prns_id=0
																)
														and (ps.pr_id = @pr_id 
																	or ps.pr_id_kit = @pr_id 
																	or @pr_id=0
																)
	)
