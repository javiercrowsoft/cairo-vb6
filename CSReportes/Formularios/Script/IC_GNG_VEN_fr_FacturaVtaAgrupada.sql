...
IC_GNG_VEN_fr_FacturaVtaAgrupada 591

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[IC_GNG_VEN_fr_FacturaVtaAgrupada]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[IC_GNG_VEN_fr_FacturaVtaAgrupada]
