if exists (select * from sysobjects where id = object_id(N'[dbo].[frBancoConciliacionSoloPendiente ]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[frBancoConciliacionSoloPendiente ]

go

/*
select * from cuenta where cue_nombre like '%doc%'
frBancoConciliacionSoloPendiente 496,'20060606','21000101',1
frBancoConciliacionSoloPendiente 141,'20060106','21000101',1

frBancoConciliacionSoloPendiente 141,'19900101 00:00:00','20061029 00:00:00',1

*/
create procedure frBancoConciliacionSoloPendiente  (
