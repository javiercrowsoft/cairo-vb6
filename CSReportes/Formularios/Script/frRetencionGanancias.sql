...
exec [frRetencionGanancias] 2512

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[frRetencionGanancias]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[frRetencionGanancias]

go
create procedure frRetencionGanancias (
