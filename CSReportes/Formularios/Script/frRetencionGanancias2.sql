...
exec [frRetencionGanancias2] 2512

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[frRetencionGanancias2]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[frRetencionGanancias2]

go
create procedure frRetencionGanancias2 (
