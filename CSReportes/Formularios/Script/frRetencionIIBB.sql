...
frRetencionIIBB 8605

*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[frRetencionIIBB]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[frRetencionIIBB]

-- frRetencionIIBB 0

go
create procedure [dbo].[frRetencionIIBB] (
...
--
  ...
  from OrdenPagoItem opgi inner join OrdenPago opg         on opgi.opg_id   = opg.opg_id
                          ...
                          left  join #t_Facturas tfc      on opgi.opgi_id = tfc.opgi_id
