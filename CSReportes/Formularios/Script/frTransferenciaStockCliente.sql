if exists (select * from sysobjects where id = object_id(N'[dbo].[frTransferenciaStockCliente]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[frTransferenciaStockCliente]
go
...
exec frTransferenciaStockCliente 3564
select * from stockitem where st_id = 3564 order by stik_id

frTransferenciaStockCliente 2
select * from stock

*/

create procedure frTransferenciaStockCliente (
