...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_lsdoc_RecuentoStocks]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_lsdoc_RecuentoStocks]
go
...
create procedure sp_lsdoc_RecuentoStocks (
