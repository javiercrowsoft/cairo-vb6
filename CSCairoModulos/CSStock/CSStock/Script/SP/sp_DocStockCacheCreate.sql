if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_DocStockCacheCreate]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_DocStockCacheCreate]
