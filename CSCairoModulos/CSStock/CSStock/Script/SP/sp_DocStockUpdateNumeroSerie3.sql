if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_DocStockUpdateNumeroSerie3]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_DocStockUpdateNumeroSerie3]
...
go
create procedure [dbo].[sp_DocStockUpdateNumeroSerie3] (
	@prns_id					int,
  @@st_id         	int,
