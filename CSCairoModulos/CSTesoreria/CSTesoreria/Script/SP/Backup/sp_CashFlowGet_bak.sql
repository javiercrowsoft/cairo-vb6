...
sp_CashFlowGet 0,0,'20061113 00:00:00','20071113 00:00:00',0,0,0,0,0,0,0

select * from cuenta where cue_nombre like '%doc%'
sp_CashFlowGet 496,'19000101','21000101'

sp_CashFlowGet 3,null,'20060329 00:00:00','20060330 00:00:00',0,0,0,0,0,0,0
...
--/////////////////////////////////////////////////////////////////////////////////////////
		...
		--/////////////////////////////////////////////////////////////////////////////////////////
				...
				insert into #t_cash_flow (doct_id, comp_id, Fecha, Descrip, Debe, Haber, Origen, Excluir, Excluir2, importe_real, fecha_real)
				...
				select  0 doct_id,
								...
								isnull(sum(case when asi_debe <> 0 then isnull(cfi_importe,asi_debe) 
																else 0 
														end
													)
												,0)	as Debe,
								isnull(sum(case when asi_haber <> 0 then isnull(cfi_importe,asi_haber) 
																else 0 
														end
													)
												,0)	as Haber,
		...
		if @@oc <> 0 begin
				...
				group by isnull(cfi_excluir,0), isnull(cfp.cfp_id,0)
		end
		--/////////////////////////////////////////////////////////////////////////////////////////
		--
		--
		...
		--/////////////////////////////////////////////////////////////////////////////////////////
				...
				select  0 doct_id,
								...
								isnull(sum(isnull(cfi_importe,mfi_importe)),0)	as Debe,
								0 								as Haber,
								0									as Origen,
				...
				select  0 doct_id,
								...
								0									as Debe,
								isnull(sum(isnull(cfi_importe,mfi_importe)),0) 	as Haber,
								0									as Origen,
...
-- 								''    		as Descrip,
-- 		
-- 								isnull(sum(isnull(cfi_importe,dbcoi_importe)),0)	as Debe,
-- 								0 								as Haber,
-- 								0									as Origen,
-- 								
-- 								isnull(cfi_excluir,0) as Excluir,
...
-- 																																and cfp2.bco_id  = cheq.bco_id
-- 
-- 				where (			(isnull(cfi_fecha,dbco_fecha) 				< @@fDesde and (@@fechacheque = 0 or dbcoi.cheq_id is null))
-- 								or	(isnull(cfi_fecha,cheq.cheq_fecha2) 	< @@fDesde and @@fechacheque <> 0)
-- 							)
-- 					and	est_id <> 7
-- 
-- 				group by isnull(cfi_excluir,0), isnull(cfp.cfp_id,0)
		...
		--/////////////////////////////////////////////////////////////////////////////////////////
				...
				select  0 doct_id,
								...
								isnull(sum(isnull(cfi_importe,cobzi_importe)),0)	as Debe,
								0 									as Haber,
								0										as Origen,
				...
				select  0 doct_id,
								...
								isnull(sum(case cobzi_otroTipo
		...
		--/////////////////////////////////////////////////////////////////////////////////////////
				...
				select  0 doct_id,
								...
								0 									as Debe,
								isnull(sum(isnull(cfi_importe,opgi_importe)),0)	as Haber,
								0										as Origen,
				...
				where (			(isnull(cfi_fecha,cheq_fecha2) 	< @@fDesde and @@fechacheque <> 0) 
				  ...
				  -- Tengo que ir hasta el asiento para ver que este conciliado
					...
					and not exists(
							...
							select * 
							from Chequera chq inner join Cuenta cue on chq.chq_id = cheq.chq_id 
																										 and chq.cue_id = cue.cue_id
		...
		declare @saldo_ini_excluido decimal(18,6)

		select  @saldo_ini = sum(debe)-sum(haber)
		from #t_cash_flow
		where excluir = 0

		select  @saldo_ini_excluido = sum(debe)-sum(haber)
		from #t_cash_flow
		where excluir <> 0

		select  @saldo_ini as saldo_inicial, @saldo_ini_excluido as saldo_ini_excluido
...
--/////////////////////////////////////////////////////////////////////////////////////////
		...
		insert into #t_cash_flow (cfi_id, doct_id, comp_id, comp_id2, Fecha, Descrip, Debe, Haber, Origen, cheq_id, cli_id, Excluir, Excluir2, importe_real, fecha_real)
...
--/////////////////////////////////////////////////////////////////////////////////////////
		if @@oc <> 0 begin
			...
			where isnull(cfi_fecha,oc_fecha) between @@fDesde and @@fHasta
				and	est_id <> 7
				and oc_pendiente >= 0.01
...
--/////////////////////////////////////////////////////////////////////////////////////////
		...
		where (			(isnull(cfi_fecha,dbco_fecha) 			between @@fDesde and @@fHasta and (@@fechacheque = 0 or dbcoi.cheq_id is null))
						or	(isnull(cfi_fecha,cheq.cheq_fecha2) between @@fDesde and @@fHasta and @@fechacheque <> 0)
					)
			and	est_id <> 7
...
--/////////////////////////////////////////////////////////////////////////////////////////
		...
		insert into #t_cash_flow (cfi_id, doct_id, comp_id, Fecha, Descrip, Debe, Haber, Origen, tjcc_id, cli_id, Excluir, Excluir2, importe_real, fecha_real)
...
--/////////////////////////////////////////////////////////////////////////////////////////
		...
		insert into #t_cash_flow (cfi_id, doct_id, comp_id, comp_id2, Fecha, Descrip, Debe, Haber, Origen, cheq_id, prov_id, Excluir, Excluir2, importe_real, fecha_real)
