...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sp_DocOrdenPagoGetCuentaAcreedor]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_DocOrdenPagoGetCuentaAcreedor]
GO
...
create procedure sp_DocOrdenPagoGetCuentaAcreedor (
	@@strIds 					  varchar(5000)
)
as
