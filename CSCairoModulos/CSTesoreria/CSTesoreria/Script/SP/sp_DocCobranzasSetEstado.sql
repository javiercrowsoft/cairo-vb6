if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_DocCobranzasSetEstado]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_DocCobranzasSetEstado]

/*

 sp_DocCobranzasSetEstado 

*/

go
create procedure sp_DocCobranzasSetEstado (
