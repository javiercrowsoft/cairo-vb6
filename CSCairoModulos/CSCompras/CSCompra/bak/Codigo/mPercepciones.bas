    ...
    Select Case Cell.Key
      Case KIP_PERC_ID
        If ValEmpty(Cell.Id, csId) Then
          MsgInfo "Debe indicar una percepcion" & strRow
          Exit Function
        End If
      Case KIP_BASE
        If ValEmpty(Cell.Value, csCurrency) Then
          MsgInfo "Debe indicar una base imponible" & strRow
          Exit Function
        End If
      Case KIP_PORCENTAJE
        If ValEmpty(Cell.Value, csCurrency) Then
