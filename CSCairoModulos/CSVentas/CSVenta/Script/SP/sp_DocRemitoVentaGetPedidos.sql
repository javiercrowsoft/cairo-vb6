if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_DocRemitoVentaGetPedidos]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_DocRemitoVentaGetPedidos]
...
exec sp_DocRemitoVentaGetPedidos 1,6,2

*/

create procedure sp_DocRemitoVentaGetPedidos (
  @@emp_id          int,
  @@cli_id           int,
  @@mon_id          int
)
