if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_DocFacturaVentaStockItemSave]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_DocFacturaVentaStockItemSave]

/*
 select * from FacturaVenta
 sp_DocFacturaVentaStockItemSave 26
