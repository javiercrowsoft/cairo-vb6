if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_DocRemitoVentaGetPedidoItems]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_DocRemitoVentaGetPedidoItems]
...
exec sp_DocRemitoVentaGetPedidoItems '1,2,3,4,5,6'

*/

create procedure sp_DocRemitoVentaGetPedidoItems (
	@@strIds 					  varchar(5000)
)
as
