if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_DocFacturaVentaGetPedidoItems]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_DocFacturaVentaGetPedidoItems]
...
exec sp_DocFacturaVentaGetPedidoItems '1,2,3,4,5,6'

*/

create procedure sp_DocFacturaVentaGetPedidoItems (
  @@strIds             varchar(5000)
)
as
        ...
        case 
          when cli_catfiscal = 1  or
               ...
               cli_catfiscal = 11 then 
                      ...
                      (((pvi_neto*pr_porcinternoc/100)*isnull(tiint.ti_porcentaje,0)/100)/pvi_cantidad) -- Internos
          ...
          when cli_catfiscal = 3 
            or cli_catfiscal = 10 then 
                      ...
                      (pvi_neto/pvi_cantidad*tirni.ti_porcentaje/100) +
                      (((pvi_neto*pr_porcinternoc/100)*isnull(tiint.ti_porcentaje,0)/100)/pvi_cantidad) -- Internos
        ...
        case 
          when cli_catfiscal = 1  or
               ...
               cli_catfiscal = 11 then 
                      ...
                      pvi_pendiente * (((pvi_neto*pr_porcinternoc/100)*isnull(tiint.ti_porcentaje,0)/100)/pvi_cantidad) -- Internos
          ...
          when cli_catfiscal = 3 
            or cli_catfiscal = 10 then 
                      ...
                      pvi_pendiente * (pvi_neto/pvi_cantidad*tirni.ti_porcentaje/100) +
                      pvi_pendiente * (((pvi_neto*pr_porcinternoc/100)*isnull(tiint.ti_porcentaje,0)/100)/pvi_cantidad) -- Internos
