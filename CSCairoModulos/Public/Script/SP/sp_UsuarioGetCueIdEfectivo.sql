if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_UsuarioGetCueIdEfectivo]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_UsuarioGetCueIdEfectivo]

go

/*

sp_UsuarioGetCueIdEfectivo 1,1

*/

create procedure sp_UsuarioGetCueIdEfectivo (
