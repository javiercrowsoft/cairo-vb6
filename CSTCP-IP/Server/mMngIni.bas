...
#If PREPROC_SERVER3 Then
  Public Const c_MainIniFile = "CSTCPIPServer3.ini"
#ElseIf PREPROC_SERVER2 Then
  Public Const c_MainIniFile = "CSTCPIPServer2.ini"
#Else
  Public Const c_MainIniFile = "CSTCPIPServer.ini"
#End If

Public Const c_K_MainIniConfig = "CONFIG"

Public Const c_K_port = "Port"
Public Const c_K_registerActivex = "RegisterActivex"
Public Const c_k_SignOnAsUnicode = "SignOnAsUnicode"
Public Const c_k_DataIsBytes = "DataIsBytes"
Public Const c_k_LogTrafic = "LogTrafic"

Public Const c_k_MainIniService = "SERVICES"
Public Const c_k_ServiceList = "ServiceList"
...
Public Function IniServiceGet(ByVal Item As String, ByVal Default As String) As String
  IniServiceGet = GetIniValue(c_k_MainIniService, Item, Default, App.Path & "\" & c_MainIniFile)
End Function
