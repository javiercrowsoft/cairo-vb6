Attribute VB_Name = "mPrintMngIni"
Option Explicit
...
Public Const c_MainIniFile = "CSPrintManagerService.ini"
...
Public Const c_k_DbId = "DbId"
Public Const c_k_InitObjects = "InitObjects"
...
Public Const c_k_rptpath = "RptPath"
