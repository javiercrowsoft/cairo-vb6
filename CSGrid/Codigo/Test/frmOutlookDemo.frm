...
Object = "{D5E078F9-5926-4845-9172-73CD66955B2C}#2.1#0"; "CSGrid.ocx"
...
Dim iMenu As Long
  saveicons
   ...
   With grdOutlook
      ...
      .AddColumn "attach", , , 12, 26, , , , True, , , CCLSortIcon
      .AddColumn "flag", , , 11, 26, , , , True, , , CCLSortIcon
...
'      Set cSUnread.Font = sFntUnread
      ...
      For iRow = 1 To 17
         ...
         iIdx = Int(Rnd * 9) + 1
         '.CellForeColor(iRow, 10) = vbRed
         '.CellForeColor(iRow, 12) = vbRed
         .CellForeColor(iRow, 13) = vbRed
         .CellDetails iRow, 14, sBody(iIdx), DT_WORDBREAK, , , vbBlue
...
Private Sub saveicons()
  ...
  For i = 1 To ilsIcons.ImageCount
    SavePicture ilsIcons.ItemPicture(i), App.Path & "\icono" & i & ".ico"
  Next
