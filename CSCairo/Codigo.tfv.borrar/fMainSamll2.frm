...
Private Sub cIMenuHost_MenuABMClick(ByVal ObjEdit As String, Obj As Object, ByVal NameABM As String, ByVal Buttons As String, ByVal Tabla As Long)
  MsgWarning "Esta es la version extra-small de Cairo y no permite editar maestros desde ventanas con arboles. Debe utilizar la version Full o la version Small."
End Sub
...
Private Sub cmdShowDesktop_Click()
  On Error Resume Next
  MsgWarning "Esta es la version extra-small de Cairo y no permite acceder al centro de reportes. Debe utilizar la versión Full o la version Small."
End Sub
