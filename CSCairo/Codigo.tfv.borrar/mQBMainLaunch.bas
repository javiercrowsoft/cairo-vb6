...
Public Sub Main()
  ...
  ShellExecute GetValidPath(App.Path) & "QBOnixSrv.exe", vbNormalFocus, False
  'ShellExecute GetValidPath(App.Path) & "QBAxionSrv.exe", vbNormalFocus, False
...
Private Function pRegistryActivex() As Boolean
  ...
  Const c_InstalApp = "QBInstall.exe"
