...
Private Const c_menu_vistas As Long = &HFFFFF
...
Private Sub csTree1_MenuClick(ByVal MenuId As Long)
  On Error Resume Next
  If MenuId = c_menu_vistas Then
  
    Dim f As fTreeViews
    Set f = New fTreeViews
    
    If f.LoadViews(csTree1.TreeId) Then
      f.AbmName = m_Name
      f.TblId = m_TblId
      f.ArbId = csTree1.TreeId
      f.Show vbModal
    End If
...
Private Sub Form_Load()
  ...
  csTree1.AddMenu "Vistas ...", c_menu_vistas
