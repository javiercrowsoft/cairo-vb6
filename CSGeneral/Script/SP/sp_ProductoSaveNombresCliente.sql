if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_ProductoSaveNombresCliente]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_ProductoSaveNombresCliente]
...
-- sp_ProductoSaveNombresCliente 1,135
