...
Public Sub MngError(ByVal NameFunction As String)
  MsgBox "Ha ocurrido un error en " & NameFunction & "." & vbCrLf & vbCrLf & "Descripcion: " & Err.Description
End Sub

Public Function Ask(ByVal Question As String) As Boolean
  Ask = MsgBox("¿" & Question & "?", vbYesNo + vbDefaultButton1 + vbQuestion) = vbYes
End Function
