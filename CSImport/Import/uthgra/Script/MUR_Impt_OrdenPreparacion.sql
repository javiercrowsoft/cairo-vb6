...
/*
  ...
  select mfc_id from MUR_OrdenPreparacion
  exec MUR_Impt_OrdenPreparacion 109513


  select count(*) from MUR_OrdenPreparacion
...
declare  @barc_id                  int
  ...
  delete MUR_OrdenPreparacion where mfc_id = @@mfc_id
  delete MUR_OrdenPreparacionItem where mfc_id = @@mfc_id
