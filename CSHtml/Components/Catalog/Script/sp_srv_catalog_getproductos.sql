if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_srv_catalog_getproductos]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_srv_catalog_getproductos]
...
/*
	...
	sp_srv_catalog_getproductos 1


*/

create procedure sp_srv_catalog_getproductos (
	@@catw_id int
)
