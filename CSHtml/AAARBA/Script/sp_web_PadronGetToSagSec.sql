if exists (select * from sysobjects where id = object_id(N'[dbo].[sp_web_PadronGetToSagSec]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_web_PadronGetToSagSec]

/*

sp_web_PadronGetToSagSec 1,'20000101','25000101','0',0
...
go
create procedure sp_web_PadronGetToSagSec (
...
--  update #tmp_padronsocio2 set pad_id = null where exists(select * from aaarbaweb..PadronSocio where pad_id_padre = #tmp_padronsocio2.pad_id)
 ...
 where
    ...
    and    est_id_sec = 1011 -- Pendiente de aplicar SAG secretaria
