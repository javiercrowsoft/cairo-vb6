...
*/
if exists (select * from sysobjects where id = object_id(N'[dbo].[ALR_DC_CSC_VEN_0020_M]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[ALR_DC_CSC_VEN_0020_M]
go

/*

ALR_DC_CSC_VEN_0020_M

*/

create procedure ALR_DC_CSC_VEN_0020_M 
