...
Begin VB.Form fManifiestoCarga 
   ClientHeight    =   6630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12750
   Icon            =   "fManifiestoCarga.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   6630
   ScaleWidth      =   12750
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   0
      Picture         =   "fManifiestoCarga.frx":058A
      Top             =   0
      Width           =   480
   End
   ...
   Begin VB.Label LB 
      BackStyle       =   0  'Transparent
      Caption         =   "DepositoLogico Destino"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "fManifiestoCarga"
...
' constantes
Private Const C_Module = "fManifiestoCarga"
...
Private Sub cbTab_Click(Index As Integer)
  With cbTab(Index)
    Select Case .Tag
      Case c_Items
        Call m_ObjItems.cbTabClick(Index, .Tag)
      Case c_Footer
