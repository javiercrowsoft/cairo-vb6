...
Begin VB.Form fMovimientoFondo 
   ClientHeight    =   6630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12540
   Icon            =   "fMovimientoFondo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   6630
   ScaleWidth      =   12540
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   0
      Picture         =   "fMovimientoFondo.frx":058A
      Top             =   0
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "fMovimientoFondo"
...
' constantes
Private Const C_Module = "fMovimientoFondo"
