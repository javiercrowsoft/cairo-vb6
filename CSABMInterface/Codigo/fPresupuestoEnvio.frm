...
Begin VB.Form fPresupuestoEnvio 
   ClientHeight    =   6630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11985
   Icon            =   "fPresupuestoEnvio.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   6630
   ScaleWidth      =   11985
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   0
      Picture         =   "fPresupuestoEnvio.frx":058A
      Top             =   0
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "fPresupuestoEnvio"
...
' constantes
Private Const C_Module = "fPresupuestoEnvio"
...
Private Sub cbTab_Click(Index As Integer)
  With cbTab(Index)
    Select Case .Tag
      Case c_Items
        Call m_ObjItems.cbTabClick(Index - 1, .Tag)
      Case c_Footer
        Call m_ObjFooter.cbTabClick(Index - 3, .Tag)
      Case Else
