...
Begin VB.Form fPedidoCompra 
   ClientHeight    =   6630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11985
   Icon            =   "fPedidoCompra.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   6630
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   0
      Picture         =   "fPedidoCompra.frx":058A
      Top             =   0
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "fPedidoCompra"
...
' constantes
Private Const C_Module = "fPedidoCompra"
