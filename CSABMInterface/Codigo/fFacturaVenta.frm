...
Begin VB.Form fFacturaVenta 
   ClientHeight    =   6630
   ClientLeft      =   0
   ClientTop       =   450
   ClientWidth     =   12540
   Icon            =   "fFacturaVenta.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   6630
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   0
      Picture         =   "fFacturaVenta.frx":058A
      Top             =   0
      Width           =   480
   End
   Begin VB.Label LB 
   ...
   End
End
Attribute VB_Name = "fFacturaVenta"
...
' constantes
Private Const C_Module = "fFacturaVenta"
