...
Begin VB.Form fCobranza 
   ClientHeight    =   6630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12045
   Icon            =   "fCobranza.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   6630
   ScaleWidth      =   12045
...
' constantes
Private Const C_Module = "fCobranza"
...
Private Sub cbTab_Click(Index As Integer)
  With cbTab(Index)
    Select Case .Tag
      ...
      Case c_Footer
        Call m_ObjFooter.cbTabClick(Index - 7, .Tag)
      Case Else
