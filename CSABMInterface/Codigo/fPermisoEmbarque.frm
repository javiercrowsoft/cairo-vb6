...
Begin VB.Form fPermisoEmbarque 
   ClientHeight    =   6630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11985
   Icon            =   "fPermisoEmbarque.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   6630
   ScaleWidth      =   11985
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   0
      Picture         =   "fPermisoEmbarque.frx":058A
      Top             =   0
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "fPermisoEmbarque"
...
' constantes
Private Const C_Module = "fPermisoEmbarque"
