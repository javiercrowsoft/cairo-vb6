...
Begin VB.Form fwCobranza 
   ClientHeight    =   6630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11880
   Icon            =   "fwCobranza.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   6630
   ...
   Begin VB.Label lbTitle2 
      BackStyle       =   0  'Transparent
      Caption         =   "Bienvenido al Asistente de Cobranza"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   14.25
         Charset         =   0
   ...
   Begin VB.Label LB2 
      BackStyle       =   0  'Transparent
      Caption         =   "Con este asistente usted podra generar los recibos por cobranzas."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label LB2 
      BackStyle       =   0  'Transparent
      Caption         =   "Indique el documento a utilizar y el cliente al que se le emitirá el recibo"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label LB2 
      BackStyle       =   0  'Transparent
      Caption         =   "Indique como tratar las diferencias de cambio"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Label LB2 
      BackStyle       =   0  'Transparent
      Caption         =   "Indique los instrumentos de cobro"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
...
' constantes
Private Const C_Module = "fwCobranza"
' estructuras
' variables privadas
...
Private Sub CB_Click(Index As Integer)
  ...
  Call m_ObjHeader.CBChange(Index)
