...
Begin VB.Form fRemitoCompra 
   ClientHeight    =   6630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   11985
   Icon            =   "fRemitoCompra.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   6630
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   0
      Picture         =   "fRemitoCompra.frx":058A
      Top             =   0
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "fRemitoCompra"
...
' constantes
Private Const C_Module = "fRemitoCompra"
