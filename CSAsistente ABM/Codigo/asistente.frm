...
Const k_server As String = "server"
...
Private Sub Form_Load()
  txtServidor.Text = GetSetting(App.EXEName, "config", k_server, "souyirozeta")
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
  SaveSetting App.EXEName, "config", k_server, txtServidor.Text
End Sub
