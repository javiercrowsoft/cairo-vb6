...
Private Property Get cISubclass_MsgResponse() As EMsgResponse
   ...
   End Select
End Property
Private Property Let cISubclass_MsgResponse(ByVal emrA As EMsgResponse)
   '
End Property

Private Function cISubclass_WindowProc(ByVal hwnd As Long, _
      ...
      If iMsg = WM_NOTIFY Then
         ...
         Else
            ...
            Case TBN_QUERYINSERT
               cISubclass_WindowProc = g_lCustomiseResponse
